...
public class InManageActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        et_remake = findViewById(R.id.et_remark_inmag);
...
//       sp_type.setPrompt(incomeBean.getType());
        ...
        } else if (incomeBean.getType().equals("比赛—奖金")) {
        ...
        }else if ( incomeBean.getType().equals("加班-济贴")) {
        ...
        et_remake.setText(incomeBean.getRemark());
    }
    ...
    private void btnModify(){
        btn_modify.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                values.put("inremark",et_remake .getText().toString());
                //把该行数据更新到收入表中
                ...
                //创建Intent对象
                Intent intent=new Intent(InManageActivity.this,InComeDetailActivity.clas);
